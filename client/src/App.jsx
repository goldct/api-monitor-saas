            ...
            <div className="max-w-6xl mx-auto px-6 py-24">
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                ...
                <div className="border-2 border-gray-900 p-8">
                  ...
                  <p className="text-3xl font-bold text-gray-900 mb-6">$9<span className="text-base text-gray-600 font-normal">/mo</span></p>
                  <ul className="space-y-3 text-gray-700">
                    <li>✓ 10 API endpoints</li>
                    <li>✓ 5-min check interval</li>
                    <li>✓ Email + Webhook alerts</li>
                    <li>✓ 30-day history</li>
                  </ul>
                </div>
                <div className="border border-gray-200 p-8">
                  <h4 className="text-xl font-bold text-gray-900 mb-3">Team</h4>
                  <p className="text-3xl font-bold text-gray-900 mb-6">$29<span className="text-base text-gray-600 font-normal">/mo</span></p>
                  <ul className="space-y-3 text-gray-700">
